        ...
        <div class="col-lg-4">
           <div class="card profile-card-2">
            <div class="card-img-block">
                <img class="img-fluid" src="assets\images\plane.jpg" alt="Card image cap">
            </div>
            <div class="card-body pt-5">
                <img src="assets\images\Company logo.jpg" alt="profile-image" class="profile">
                <h5 class="card-title">Krutarth Raychura</h5>
                 ...
                 <div class="media align-items-center">
                  ...
                  <div class="media align-items-center">
                   <div><img src="assets/images/timeline/bootstrap-4.svg" class="skill-img" alt="skill img"></div>
                     <div class="media-body text-left ml-3">
                       <div class="progress-wrapper">
                         <p>Bootstrap 4 <span class="float-right">80%</span></p>
                         <div class="progress" style="height: 5px;">
                ...
                <div class="tab-pane active" id="profile">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <h6>Hobbies</h6>
                            <p>
                                Web Designer,Front End Developer & Backend Developer.
                            </p>
                        </div>
                        <div class="col-md-6">
                            <h6>Recent badges</h6>
                ...
                <div class="tab-pane" id="edit">
                    <form>
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input class="form-control" type="text" value="Het">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label form-control-label">Last name</label>
                            <div class="col-lg-9">
                                <input class="form-control" type="text" value="Patel">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label form-control-label">Email</label>
                            <div class="col-lg-9">
                                <input class="form-control" type="email" value="het@example.com">
                            </div>
                        </div>
                        <div class="form-group row">
